...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { role_id: @permission.role_id, room_id: @permission.room_id, user_id: @permission.user_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { role_id: @permission.role_id, room_id: @permission.room_id, user_id: @permission.user_id } }
